...
<ul>
  ...
  <li><b>Data & Processing:</b> Pandas, NumPy, JSON, Regex</li>
  <li><b>Backend & APIs:</b> FastAPI, Flask, Django, REST APIs</li>
  <li><b>LLM & AI:</b> LangChain, OpenAI API, Prompt Engineering</li>
